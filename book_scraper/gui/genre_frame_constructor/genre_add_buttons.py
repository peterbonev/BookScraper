...
from genre_entry_list_add_buttons_control import GenresEntryListAddButtonsControl
...
class BookScraperApplicationGenresAddButtons(object):
    ...
    def _add_control(self, frame, genres_list_from, genres_list_to):
        ...
        single_add_control_functions = GenresEntryListAddButtonsControl(
            self.genres_list_const, self.genres_list_new
        )._add_item_search_list_genres
        all_add_control_functions = GenresEntryListAddButtonsControl(
            self.genres_list_const, self.genres_list_new
        ...
        self.select_genre_button_add = Button(
            self.__select_genre_buttons,
            text="ADD",
