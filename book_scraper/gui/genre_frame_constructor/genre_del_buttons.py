...
class BookScraperApplicationGenresDelButtons(object):
    ...
    def _del_control(self, frame, genres_list_from, genres_list_to):
        ...
        del_control_functions = GenresEntryListDelButtonsControl(genres_list_from, genres_list_to)._del_item_list_genres
        del_all__control_function = GenresEntryListDelButtonsControl(genres_list_from, genres_list_to)._del_all_list_genres
