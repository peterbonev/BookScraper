...
class BookScraperApplicationSearchRadiobuttons(object):
    ...
    def _radiobuttons(self, frame):
        ...
        self.keywords_radio = Radiobutton(frame, text="Keywords", variable=option_keyword_title, value=0)
        ...
        self.titles_radio = Radiobutton(frame, text="Titles", variable=option_keyword_title, value=1)
